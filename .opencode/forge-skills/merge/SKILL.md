...
**Announce at start:** "I'm using the forge:merge skill to complete this work."
...
If the base branch is ambiguous, confirm through `forge:ask`:
- header: `Base Branch`
...
**Normal repo / named-branch worktree — use `forge:ask`:**
...
If no user is available, do NOT discard — keep the branch as-is. (Destructive actions never auto-approve; see `forge:ask`.)
